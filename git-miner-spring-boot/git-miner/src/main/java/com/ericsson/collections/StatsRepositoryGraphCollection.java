...
@Document("StatsRepository")
public class StatsRepositoryGraphCollection {
    @Id
    private String repoName;
    private List<Map<String, String>> graphHeaderAndValues;

    public StatsRepositoryGraphCollection(String repoName, List<Map<String, String>> graphHeaderAndValues) {
