...
public class TestStatsRepositoryGraphCollection {
    ...
    @Test
    public void verifyThatCanCreateEmptyTestStatsRepositoryGraph() {
        StatsRepositoryGraphCollection empty = new StatsRepositoryGraphCollection(EMPTY_REPO_NAME, EMPTY_GRAPH_HEADER_AND_VALUES);
        assertEquals(empty.toString(), EMPTY_GRAPH_HEADER_AND_VALUES.toString());
    }

    @Test
    public void verifyThatCanGetRepoName() {
        StatsRepositoryGraphCollection repoName = new StatsRepositoryGraphCollection(TEST_REPO_NAME, EMPTY_GRAPH_HEADER_AND_VALUES);
    ...
    public void verifyThatCanGetGraphHeaderAndValues() {
        ...
        StatsRepositoryGraphCollection repoName = new StatsRepositoryGraphCollection(EMPTY_REPO_NAME, graphWithHeaders);
